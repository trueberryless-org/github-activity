  ...
  return (
    <div className="w-full bg-gray-900 text-white p-6 rounded-lg shadow-lg border border-gray-800">
      <div className="flex items-center gap-4">
        ...
        <div>
          <a href={`https://github.com/${repo.name}`} className="text-lg font-semibold text-blue-400 hover:underline">
            {repo.name}
          </a>
      ...
      {latestCommit && (
        <>
          ...
          <a href={latestCommit.url} className="mt-3 block text-sm text-gray-500 hover:text-gray-400">
